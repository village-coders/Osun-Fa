...
export default function CoachSettingsPage() {
        ...
        const fetchProfile = async () => {
            try {
                ...
                setFormData({
                    ...
                    licenseLevel: user.licenseLevel || "CAF B"
                });
            } catch (error) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-white mb-2">Coach Settings</h1>
                <p className="text-gray-400">Update your profile, licenses, password, and contact information.</p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden divide-y divide-white/10">
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-gray-400">License Level</label>
                            <select
                                name="licenseLevel"
                            ...
                            >
                                <option className="text-black" value="CAF A">CAF A</option>
                                <option className="text-black" value="CAF B">CAF B</option>
                                <option className="text-black" value="CAF C">CAF C</option>
                                <option className="text-black" value="NIS">NIS</option>
                            </select>
                        </div>
                    </div>
